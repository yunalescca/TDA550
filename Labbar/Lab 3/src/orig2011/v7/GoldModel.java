...
public class GoldModel implements GameModel {
	...
	private Dimension size = Constants.getGameSize();
	...
	public GoldModel() {
		...
		GameUtils.setGameboardState(this.collectorPos, COLLECTOR_TILE, gameboard);
	...
	private void addCoin() {
		...
		GameUtils.setGameboardState(newCoinPos, COIN_TILE, gameboard);
	...
	public void gameUpdate(final int lastKey) throws GameOverException {
		...
		GameUtils.setGameboardState(this.collectorPos, BLANK_TILE, gameboard);
		...
		this.coins.remove(0);
		GameUtils.setGameboardState(oldCoinPos, BLANK_TILE, gameboard);

		// Add a new coin (simulating moving one coin)
		addCoin();

		pcs.firePropertyChange("Board update", false, true);
